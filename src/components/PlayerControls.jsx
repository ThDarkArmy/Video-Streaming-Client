      ...
      >
        ...
        <Grid item>
          <Grid container alignItems="center" direction="row">
            ...
            <Button onClick={onChangeTimeDisplayFormat} variant="text" style={{ color: "#fff", marginLeft: 16 }}>
            ...
            <Grid container direction="column-reverse">
              {[0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2].map((rate) => (
                <Button 
                  ...
                  variant="text">
                  <Typography color={playbackRate===rate?"secondary":"inherit"}>{rate}</Typography>
                </Button>
              ))}
            </Grid>
          </Popover>
